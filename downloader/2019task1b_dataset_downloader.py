...
try:
    ...
    if pkg_resources.parse_version(pkg_resources.get_distribution("dcase_util").version) < pkg_resources.parse_version('0.2.8'):
        raise AssertionError(
            'Please update your dcase_util module, version >= 0.2.8 required. \n'
...
def main(argv):
    ...
    parser = argparse.ArgumentParser(
        ...
        description=textwrap.dedent(
            ...
            '''.format(app_title='Task 1B: Acoustic Scene Classification with mismatched recording devices')
        )
    )
    ...
    dataset_map = {
        'dev': 'TAUUrbanAcousticScenes_2019_Mobile_DevelopmentSet',
        'leaderboard': 'TAUUrbanAcousticScenes_2019_Mobile_LeaderboardSet',
        'eval': 'TAUUrbanAcousticScenes_2019_Mobile_EvaluationSet',
        'train': 'TAUUrbanAcousticScenes_2019_Mobile_DevelopmentSet',
        'test': 'TAUUrbanAcousticScenes_2019_Mobile_LeaderboardSet',
    }
