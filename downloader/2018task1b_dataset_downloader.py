...
try:
    ...
    if pkg_resources.parse_version(pkg_resources.get_distribution("dcase_util").version) < pkg_resources.parse_version(
            '0.2.2'):
        raise AssertionError(
            'Please update your dcase_util module, version >= 0.2.2 required. \n'
...
def main(argv):
    ...
    dataset_map = {
        'dev': 'TUTUrbanAcousticScenes_2018_Mobile_DevelopmentSet',
        'leaderboard': 'TUTUrbanAcousticScenes_2018_Mobile_LeaderboardSet',
        'eval': 'TUTUrbanAcousticScenes_2018_Mobile_EvaluationSet',
        'train': 'TUTUrbanAcousticScenes_2018_Mobile_DevelopmentSet',
        'test': 'TUTUrbanAcousticScenes_2018_Mobile_LeaderboardSet',
    }
