...
try:
    ...
    if pkg_resources.parse_version(pkg_resources.get_distribution("dcase_util").version) < pkg_resources.parse_version('0.2.2'):
...
def main(argv):
    ...
    dataset_map = {
        'dev': 'TUTUrbanAcousticScenes_2018_DevelopmentSet',
        'leaderboard': 'TUTUrbanAcousticScenes_2018_LeaderboardSet',
        'eval': 'TUTUrbanAcousticScenes_2018_EvaluationSet',
        'train': 'TUTUrbanAcousticScenes_2018_DevelopmentSet',
        'test': 'TUTUrbanAcousticScenes_2018_LeaderboardSet',
    }
